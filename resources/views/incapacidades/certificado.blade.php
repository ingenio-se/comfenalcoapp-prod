...
<div class="row">
    <div class="col-sm-12  mx-auto">
        <table class="table table-bordered">
            <tr>
            <td ><img  src="img/comfenalcovalle.png" width="60" height="27"></td>
...
<div class="row">
    ...
    <table class="table table-bordered table-sm">
            ...
            <td colspan="2">{{ $i["Nombre del paciente"] }}</td>
    ...
    <table class="table table-bordered table-sm">
            ...
            <tr>
                ...
                <td class="font-weight-bold">Días acumulados</td><td>{{ $i["Días acumulados"] }}</td>
            </tr>
    </table>
    <table class="table table-bordered table-sm">
        <tr><td class="font-weight-bold">Diagnostico principal</td><td>{{ $i["Diagnostico principal"] }}</td>   
        <td class="font-weight-bold">Diag. rel 1</td><td>{{ $i["Diagnostico relacionado 1"] }}</td>  
        <td class="font-weight-bold">Diag.rel 2</td><td>{{ $i["Diagnostico relacionado 2"] }}</td>  
        <td class="font-weight-bold">Contingencia origen</td><td>{{ $i["Contingencia origen"] }}</td>
        <td class="font-weight-bold">SOAT</td><td>{{ $i["SOAT"] }}</td>
        </tr>   
    </table>
    <table class="table table-bordered table-sm">
        <tr><td class="font-weight-bold">Grupo de servicio</td><td>{{ $i["Grupo de servicio"] }}</td>   
        <td class="font-weight-bold">Modo Prestación de Servicio</td><td>{{ $i["modo prestacion"] }}</td>  
        <td class="font-weight-bold">Incapacidad retroactiva</td><td>{{ $i["incapacidad retroactiva"] }}</td>  
    ...
    <br>
    <p style="margin: 0">__________________________________________________________________________________________</p>
    <p style="margin: 0" class="font-weight-bold">{{ $i["Nombre del profesional que genera"]}} - 
    {{  $i["Tipo doc profesional que genera"]." ".$i["Numero doc profesional que genera"]." - ".$i["Especialidad"] }}</p>
    <!--<table class="table" > 
        <tr><td class="font-weight-bold">{{ $i["Nombre del profesional que genera"]}}</td></tr> 
        <tr><td class="font-weight-bold">{{  $i["Tipo doc profesional que genera"]." ".$i["Numero doc profesional que genera"]." ".$i["Especialidad"] }}</td></tr>
    </table>-->
